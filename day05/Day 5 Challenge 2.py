...
for instruction in instructions():
    ...
    # places[destination].insert(0, places[origin][:amount])
    # places[origin] = places[origin][amount:]
    for index, x in enumerate(range(0, amount)):
        places[destination].insert(index, places[origin][index])
    places[origin] = places[origin][amount:]
    print(places)
#
print(places)
